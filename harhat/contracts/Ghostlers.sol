...
// ================== Mint Functions Start =======================
  ...
  function WL_Mint_PH1(uint256 _mintAmount) public payable {
    ...
    // Normal requirements 
    require(set_wl_sale_ph1==true, 'Free Mint Phase 1 is Paused.');
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, 'Invalid Mint Amount!');
    require(totalSupply() + _mintAmount <= maxSupply, 'Max Supply Exceeded!');
    require(whitelist_ph1[msg.sender], "You are not Whitelisted For Phase 1."); 
    require(msg.value >= price * _mintAmount, 'Insufficient Funds!');
    ...
    // Normal requirements 
    require(set_wl_sale_ph2==true, 'Free Mint Phase 2 is Paused.');
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, 'Invalid Mint Amount!');
    require(totalSupply() + _mintAmount <= maxSupply, 'Max supply exceeded!');
